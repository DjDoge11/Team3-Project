  ...
  return (
    <main className="container">
      <div className="card" style={{ margin: '1.5rem 0' }}>
        <h1 style={{ marginTop: 0, color: 'var(--color-primary)' }}>Welcome To Our Website!</h1>
        <p className="lead">This is a website for calculating grades, made primarily for Canyon Crest Academy students.</p>
        <h4 style={{ marginBottom: '0.5rem' }}>Our features include:</h4>
